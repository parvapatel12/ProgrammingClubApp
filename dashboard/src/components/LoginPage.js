          ...
          <span>
            ...
            {this.state.isUser ? (
              <div>
                <h1>
                  {" "}
                  You are already a user...!! Wait till we redirect you to the
                  grandeur of all platforms...!!
                </h1>
              </div>
            ) : (
              <span>
                <p>
                  {" "}
                  You will need to enter a unique username to enroll yourself as
                  a user here. Enter the name in the textbox given below and
                  press "Enter".{" "}
                </p>
                <input
                  type="text"
